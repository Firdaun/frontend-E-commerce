                        ...
                        <div className="flex-1 flex flex-col lg:block">
                            <div className="bg-gray-900/70 border border-gray-900 rounded-3xl p-6 sticky top-24 mt-auto lg:mt-0">
                                ...
                                <button
                                    ...
                                    className="w-full cursor-pointer bg-seblak-gradient py-4 rounded-2xl font-black text-white shadow-lg shadow-red-500/20 active:scale-95 transition-transform"
                                >
                                    Bayar Sekarang
                                </button>
