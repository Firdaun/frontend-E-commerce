...
export default function Hero() {
    ...
    return (
        <section className="relative pt-25 pb-10 md:pt-36 md:pb-20">
            <div className="max-w-7xl w-[95%] mx-auto xl:min-h-screen relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        <motion.div variants={itemVariants} className="inline-flex items-center space-x-2 bg-red-500/10 text-red-500 px-4 py-2 rounded-full mb-3 border border-red-500/20">
                            ...
                            <span className="font-semibold tracking-wide text-xs lg:text-sm ">LEVEL PEDAS BISA DIATUR!</span>
                        </motion.div>

                        <motion.h1 variants={itemVariants} className="text-4xl lg:text-5xl font-black text-white mb-3 leading-tight">
                            Seblak <span className="text-transparent bg-clip-text bg-seblak-gradient">Hot Jeletot</span> <br />
                            Bikin Nagih.
                        </motion.h1>

                        <motion.p variants={itemVariants} className="text-xs text-gray-400 mb-6 max-w-lg mx-auto md:mx-0 leading-relaxed">
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                            <button className="w-full sm:w-auto bg-seblak-gradient hover:from-orange-600 hover:to-red-700 text-white px-5 py-3 lg:px-8 lg:py-4 rounded-full font-bold text-sm transition-transform transform hover:scale-105 flex items-center justify-center space-x-2 shadow-lg shadow-red-500/30">
                                <span>Pesan Sekarang</span>
                                <ArrowRight size={20} />
                            </button>
                            <button className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-700 px-5 py-3 lg:px-8 lg:py-4 rounded-full font-bold text-sm transition-colors">
                                Lihat Menu
                            </button>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="flex justify-center relative order-first md:order-0">
                        <motion.div
                            ...
                            className="w-[70%] md:w-full relative"
                        >
